...
newplaylisturi = pm.sp.user_playlist_create(pm.username, newplaylistname, public=False)[
    "id"
]
...
explodedplaylisturi = pm.sp.user_playlist_create(
    pm.username, explodedplaylistname, public=False
)["id"]
